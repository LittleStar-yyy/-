...
public class MainActivity2 extends AppCompatActivity implements ViewPager.OnPageChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ib_start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("begin","begin");//extras根据改页面对应的人物信息进行修改
    ...
    private void initPoint() {
        ...
        for (int i = 0;i<size;i++){
            ...
            iv_point.setPadding(100,0,100,0);//left,top,right,bottom
    ...
    private void initViewPager() {
        ...
        //实例化图片资源
        imageIdArray = new int[]{R.mipmap.welcome_1,R.mipmap.welcome_2,R.mipmap.welcome_3};
